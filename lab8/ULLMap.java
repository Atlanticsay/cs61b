...
public class ULLMap<K, V>  implements Map61B<K, V> {
    ...
    /**
     * Keys and values are stored in a linked list of EntryKV objects.
     * This variable stores the first pair in this linked list.
     */
    private EntryKV list;

    /**
     * Represents one node in the linked list that stores the key-value pairs
     * in the dictionary.
     */
    private class EntryKV {
        
        /**
         * Stores KEY as the key in this key-value pair, VAL as the value, and
         * NEXT as the next node in the linked list.
         */
        EntryKV(K k, V v, EntryKV n) {
            key = k;
            val = v;
            next = n;
        }
        ...
        /**
         * Returns the EntryKV in this linked list of key-value pairs whose key
         * is equal to KEY, or null if no such EntryKV exists.
         */
        EntryKV get(K k) {
        ...
        V val;
        /** Stores the next EntryKV in the linked list. */
        EntryKV next;
